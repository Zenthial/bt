...
void output(int happiness_strength, int dimensions, char board[][MAX_SIZE], int end_percent, int vacancy_percent, int cycle, int moves_this_cycle) {
...
void handle_print_cycle(int num_cycles, int size, char board[][MAX_SIZE], int happiness_strength, int end_percent, int vacancy_percent) {
    ...
    output(happiness_strength, size, board, end_percent, vacancy_percent, cycle, moves_this_cycle);
    cycle++;
